...
val_image_transform = transforms.Compose([transforms.RandomCrop(hps.img_crop_size, pad_if_needed=True),
                                      transforms.Resize(hps.img_resize),
                                      transforms.ToTensor()])
train_dataset = PretrainImageDataset('/data/shared/nips_pretrain/', transform=image_transform)
val_dataset = PretrainImageDataset('/data/shared/nips_pretrain/', train=False, transform=val_image_transform)
